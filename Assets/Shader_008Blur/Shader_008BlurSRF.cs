...
public class Shader_008BlurSRF : ScriptableRendererFeature
{
    class Shader_008BlurPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            volume = stack.GetComponent<Shader_008BlurVolume>();
            if (!volume.IsActive())
            {
                return;
            }
        ...
        {
            string shaderName = "Shader/Shader_008Blur";
            return shaderName;
        }
    ...
    Shader_008BlurPass m_ScriptablePass;

    /// <inheritdoc/>
    public override void Create()
    {
        m_ScriptablePass = new Shader_008BlurPass();
