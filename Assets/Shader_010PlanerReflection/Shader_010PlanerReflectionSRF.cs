...
public class Shader_010PlanerReflectionSRF : ScriptableRendererFeature
{
    class Shader_010PlanerReflectionPass : ScriptableRenderPass
    {

        public static string k_RenderTag = "Shader_010SSAOPass";

        private Shader_010PlanerReflectionVolume volume;
        ...
        public Shader_010PlanerReflectionPass()
        {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            volume = stack.GetComponent<Shader_010PlanerReflectionVolume>();
            if (!volume.IsActive())
            {
                return;
            }
    ...
    Shader_010PlanerReflectionPass m_ScriptablePass;

    /// <inheritdoc/>
    public override void Create()
    {
        m_ScriptablePass = new Shader_010PlanerReflectionPass();
