...
public class Shader_014SSRefractionSRF : ScriptableRendererFeature
{
    class Shader_014SSRefractionPass : ScriptableRenderPass
    {

        public static string k_RenderTag = "Shader_014SSRefraction";

        private Shader_014SSRefractionVolume volume;
        ...
        public Shader_014SSRefractionPass()
        {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            volume = stack.GetComponent<Shader_014SSRefractionVolume>();
            if (!volume.IsActive())
            {
                return;
            }
        ...
        {
            string shaderName = "Shader/Shader_014SSRefraction";
            return shaderName;
        }
    ...
    Shader_014SSRefractionPass m_ScriptablePass;

    /// <inheritdoc/>
    public override void Create()
    {
        m_ScriptablePass = new Shader_014SSRefractionPass();
