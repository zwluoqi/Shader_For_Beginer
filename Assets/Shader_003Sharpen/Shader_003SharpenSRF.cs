...
public class Shader_003SharpenSRF : ScriptableRendererFeature
{
    class Shader_003SharpenPass : ScriptableRenderPass
    {

        public static string k_RenderTag = "Shader_003SharpenPass";

        private Shader_003SharpenVolume _shader002PixelizationVolume;
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            _shader002PixelizationVolume = stack.GetComponent<Shader_003SharpenVolume>();
        ...
        {
            string                     shaderName = "Shader/Shader_003Sharpen";
    ...
    Shader_003SharpenPass m_ScriptablePass;

    /// <inheritdoc/>
    public override void Create()
    {
        m_ScriptablePass = new Shader_003SharpenPass();
