...
public class Shader_005FilmGrainSRF : ScriptableRendererFeature
{
    class Shader_005FilmGrainPass : ScriptableRenderPass
    {

        public static string k_RenderTag = "Shader_005FilmGrain";

        private Shader_005FilmGrainVolume _shader002PixelizationVolume;
        ...
        public Shader_005FilmGrainPass()
        {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            _shader002PixelizationVolume = stack.GetComponent<Shader_005FilmGrainVolume>();
        ...
        {
            string                     shaderName = "Shader/Shader_005FilmGrain";
    ...
    Shader_005FilmGrainPass m_ScriptablePass;

    /// <inheritdoc/>
    public override void Create()
    {
        m_ScriptablePass = new Shader_005FilmGrainPass();
