...
public class Shader002PixelizationSRF : ScriptableRendererFeature
{
    class Shader002PixelizationPass : ScriptableRenderPass
    {

        public static string k_RenderTag = "Shader002PixelizationPass";

        private Shader002PixelizationVolume _shader002PixelizationVolume;
        ...
        public Shader002PixelizationPass()
        {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            _shader002PixelizationVolume = stack.GetComponent<Shader002PixelizationVolume>();
        ...
        {
            string                     shaderName = "Shader/Shader_002Pixelization";
    ...
    Shader002PixelizationPass m_ScriptablePass;

    /// <inheritdoc/>
    public override void Create()
    {
        m_ScriptablePass = new Shader002PixelizationPass();
